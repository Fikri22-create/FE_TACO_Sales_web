    ...
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-800 mb-8">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          ...
          <div className="flex items-center gap-3 min-w-0 mt-4 lg:mt-0 lg:mr-8">
            ...
            <button
              ...
              className="shrink-0 whitespace-nowrap inline-flex items-center gap-2 px-4 py-2.5 bg-primary-500 hover:bg-primary-600 text-white rounded-xl transition-all duration-200 text-sm font-medium shadow-sm hover:shadow focus:ring-2 focus:ring-primary-500/20 focus:outline-none"
            >
              <FaDownload className="w-4 h-4 text-primary-50" />
              Export CSV
            </button>
          </div>
        </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-3 bg-primary-100 dark:bg-primary-500/20 rounded-2xl">
                    <FaChartLine className="w-5 h-5 text-primary-600 dark:text-primary-400" />
                  </div>
                ...
                <div className="flex items-center gap-2 mt-4">
                  <span className="px-2.5 py-1 rounded-full bg-success-50 text-success-700 dark:bg-success-500/20 dark:text-success-400 text-xs font-bold flex items-center gap-1">
                    <FaArrowUp className="w-3 h-3" />
                    +12%
                  </span>
                  <span className="text-sm font-medium text-gray-500 dark:text-gray-400">dari minggu lalu</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-3 bg-secondary-100 dark:bg-secondary-500/20 rounded-2xl">
                    <FaChartBar className="w-5 h-5 text-secondary-600 dark:text-secondary-400" />
                  </div>
                ...
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-4">
                  {topCompetitorSignals} sinyal minggu ini
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-3 bg-warm-100 dark:bg-warm-500/20 rounded-2xl">
                    <FaInfoCircle className="w-5 h-5 text-warm-700 dark:text-warm-500" />
                  </div>
          ...
          {competitorBrands.map((brand) => {
            ...
            return (
              <button
                ...
                className={`inline-flex items-center gap-3 px-5 py-3 rounded-2xl border transition-all duration-300 text-sm font-bold shadow-sm ${
                  active
                    ? 'border-primary-200 bg-primary-50 text-primary-700 dark:border-primary-500/40 dark:bg-primary-500/15 dark:text-primary-300'
                    : 'border-gray-200 text-gray-600 bg-white hover:border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:border-gray-600'
                }`}
              >
                {active ? <FaEye className="w-4 h-4 text-primary-500" /> : <FaEyeSlash className="w-4 h-4 text-gray-400" />}
                <span className="w-3.5 h-3.5 rounded-full" style={{ backgroundColor: brand.color }} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <div className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 p-8 shadow-sm">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            ...
            <span className="px-4 py-2 bg-success-50 text-success-700 dark:bg-success-500/15 dark:text-success-400 text-sm font-bold rounded-xl">
              Update Langsung
            </span>
          </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 p-8 shadow-sm">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            ...
            <span className="px-4 py-2 bg-primary-50 text-primary-700 dark:bg-primary-500/15 dark:text-primary-400 text-sm font-bold rounded-xl">
              4 Minggu Terakhir
            </span>
          </div>
          ...
          {outletTypeBreakdown.map((item) => (
            ...
            >
              ...
              <div className="flex justify-between mt-3">
                <span className="text-sm font-bold text-gray-700 dark:text-gray-300">{item.percentage}%</span>
