      ...
      {open && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            aria-modal="true"
            aria-label={title}
            className={`relative z-[101] w-full ${panelWidth} max-h-[85vh] overflow-y-auto rounded-2xl border border-gray-200 bg-white shadow-2xl outline-none dark:border-gray-700 dark:bg-gray-900`}
